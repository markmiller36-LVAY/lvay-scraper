...
function lvay_winter_assets() {
    ...
    .lvay-w-archive{align-self:start;background:#050505;color:#fff!important;padding:22px 25px 26px;display:grid;grid-template-columns:1fr 1fr;gap:8px 18px;height:max-content}.lvay-w-archive h3{grid-column:1/-1;color:#fff!important;font:500 36px/1 Teko;margin:0 0 9px;text-decoration:underline;text-underline-offset:5px}.lvay-w-archive a{color:#999!important;font:500 29px/1 Teko;text-decoration:none!important}.lvay-w-archive a:hover,.lvay-w-archive a.active{color:#fff!important}.lvay-w-archive span{grid-column:1/-1;color:#aaa!important;font:21px/1.15 Teko;margin-top:12px}
    ...
    .lvay-w-school>button{width:100%;min-height:50px;text-align:left;border:0;border-bottom:1px solid #e7e9e9;background:#fff!important;color:#080808!important;padding:8px 45px;font:500 25px Teko}.lvay-w-school>button:hover{background:#000!important;color:#fff!important}.lvay-w-school>button[aria-expanded=true]{background:#333!important;color:#fff!important}.lvay-w-school>div{padding:10px;overflow:auto}
